...
data.model$evDiffNoResetScaled = scale_this(data.model$evDiff_noReset)
...
data.model.noReset <- data.model %>%
    filter(blockID > 1)

#rescale variables
data.model.noReset$evDiffScaled <- scale_this(data.model.noReset$evDiffScaled)
data.model.noReset$varDiffScaled <- scale_this(data.model.noReset$varDiffScaled)
data.model.noReset$novelDiffScaled <- scale_this(data.model.noReset$novelDiffScaled)
data.model.noReset$evDiffNoResetScaled <- scale_this(data.model.noReset$evDiffNoResetScaled)
data.model.noReset$ageScaled <- scale_this(data.model.noReset$ageScaled)
...
#scale
data.model$selectedUncertainty <- scale_this(data.model$selectedUncertainty)
data.model$selectedValue <- scale_this(data.model$selectedValue)
data.model$selectedNovelty <- scale_this(data.model$selectedNovelty)
data.model$evDiffScaled <- scale_this(data.model$evDiffScaled)
data.model$ageScaled <- scale_this(data.model$ageScaled)
...
#scale trial number
data.model$trialScaled <- scale_this(data.model$trialID)
...
#scale
data.model.children$selectedUncertainty <- scale_this(data.model.children$selectedUncertainty)
data.model.children$selectedValue <- scale_this(data.model.children$selectedValue)
data.model.children$selectedNovelty <- scale_this(data.model.children$selectedNovelty)
data.model.children$evDiffScaled <- scale_this(data.model.children$evDiffScaled)
data.model.children$ageScaled <- scale_this(data.model.children$ageScaled)
data.model.children$trialScaled <- scale_this(data.model.children$trialID)
