% This script sets the parameters for the instructions and practice trials
...
%     nextKeys{29} = KbName('space');
    ...
    nextKeys{30} = KbName('space');
    
    % initialize the instruction display; change to make instruction slides
    % bigger for the screen (adapt dependent on testing monitor size). 
    instructionWidth = 1500 * 1; % width
    instructionHeight = 844 * 1; % height
